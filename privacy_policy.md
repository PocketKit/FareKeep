...
- **Delete Cloud Account:** From **Settings → Account → Danger Zone**, you can delete your cloud account (authentication credentials). Your local data remains on your device, and you revert to Guest mode. Any existing backups in your Google Drive are not automatically deleted.
- **Delete Account & Data:** From **Settings → Account → Danger Zone**, you can delete your cloud account **and** permanently erase all local data from your device. Existing backups in your Google Drive remain untouched and can be deleted manually from Google Drive.
